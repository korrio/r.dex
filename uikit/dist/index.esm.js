...
var Icon$16 = function (props) { return (React.createElement("svg", __assign({ viewBox: "0 0 43 41" }, props),
    React.createElement("path", { d: "M42.1673 3.63284L33.9756 6.24134C30.6658 2.87404 26.1847 0.983459 21.5133 0.983459C16.8419 0.983459 12.3608 2.87404 9.05098 6.24134L0.865967 3.63284L5.35495 11.7055C4.22747 14.2938 3.71189 17.1168 3.84988 19.9463C3.98787 22.7758 4.77556 25.5324 6.14929 27.9935C7.52303 30.4546 9.44428 32.551 11.7578 34.1134C14.0713 35.6757 16.7122 36.6603 19.467 36.9874L21.4831 40.5638L23.4991 36.9874C26.2539 36.6603 28.8948 35.6757 31.2083 34.1134C33.5218 32.551 35.4431 30.4546 36.8168 27.9935C38.1906 25.5324 38.9782 22.7758 39.1162 19.9463C39.2542 17.1168 38.7386 14.2938 37.6112 11.7055L42.1673 3.63284ZM21.5167 3.22097C25.1976 3.22592 28.7566 4.56916 31.5564 7.01016L26.0392 8.7606L21.5099 16.7715L16.9873 8.7606L11.4702 7.01016C14.2733 4.57026 17.8339 3.22729 21.5167 3.22097ZM10.0926 29.7659C8.24134 27.7092 6.95548 25.1889 6.36539 22.4608C5.7753 19.7326 5.90197 16.8936 6.73256 14.2316L13.1502 25.6953L14.9848 23.0319L6.9812 8.6645L15.0453 11.2318L19.9442 19.8399L14.5681 28.2969L18.0558 34.475C15.0046 33.7623 12.2371 32.1202 10.1195 29.7659H10.0926ZM21.5167 34.674L17.9282 28.3793L21.4629 22.7779L24.9506 28.544L21.5167 34.674ZM36.9727 19.0505C36.9799 22.6325 35.7945 26.1105 33.611 28.9135C31.4276 31.7164 28.376 33.6776 24.9573 34.475L28.3173 28.4891L23.1093 19.8467L28.0082 11.2318L36.0723 8.6645L28.0082 23.128L29.7621 25.9355L36.3075 14.2247C36.7864 15.786 37.0222 17.4144 37.0064 19.0505H36.9727Z", fill: "#EA0029" }))); };
...
var templateObject_1$O, templateObject_2$m, templateObject_3$a, templateObject_4$7;
...
var Breadcrumbs = function (_a) {
    ...
    return (React.createElement(StyledBreadcrumbs, null, items === null || items === void 0 ? void 0 : items.map(function (item, index) { return (React.createElement("li", { key: "child-" + index }, item)); })));
};
...
var lightColors = __assign(__assign(__assign({}, baseColors), additionalColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", backgroundAlt: "#FFFFFF", cardBorder: "#E7E3EB", contrast: "#191326", dropdown: "#F6F6F6", dropdownDeep: "#EEEEEE", invertedContrast: "#FFFFFF", input: "#eeeaf4", inputSecondary: "#d7caec", tertiary: "#EFF4F5", text: "#2c2c2c", textDisabled: "#BDC2C4", textSubtle: "#6d6d6d", borderColor: "#E9EAEB", gradients: {
...
var darkColors = __assign(__assign(__assign({}, baseColors), additionalColors), { secondary: "#9A6AFF", background: "#08060B", backgroundDisabled: "#3c3742", backgroundAlt: "#27262c", cardBorder: "#383241", contrast: "#FFFFFF", dropdown: "#1E1D20", dropdownDeep: "#100C18", invertedContrast: "#191326", input: "#372F47", inputSecondary: "#262130", primaryDark: "#90a4ae", tertiary: "#353547", text: "#F4EEFF", textDisabled: "#666171", textSubtle: "#e2e9f0", borderColor: "#524B63", gradients: {
...
var Logo$2 = function (_a) {
    ...
    return (React.createElement(Svg, __assign({ height: "40", viewBox: "0 0 209 62" }, props),
        React.createElement("g", { transform: "scale(1)" },
            React.createElement("path", { d: "M72.1463 21.0602L77.5223 36.4779L82.8984 21.0602H86.9707L79.1889 41.4478H75.9364L68.074 21.0602H72.1463Z", fill: "#EA0029" }),
            React.createElement("path", { d: "M96.8828 41.5919C95.5087 41.6108 94.1483 41.3104 92.9045 40.7132C91.7431 40.1511 90.7018 39.3603 89.8402 38.3862C88.1192 36.4254 87.1627 33.8875 87.1522 31.254C87.1465 29.9152 87.3976 28.5882 87.8914 27.3481C88.3746 26.1212 89.0739 24.9951 89.9544 24.0257C90.8311 23.0632 91.8865 22.2885 93.0591 21.7467C94.2841 21.1753 95.6168 20.8847 96.9634 20.8955C98.3319 20.8772 99.6854 21.1876 100.915 21.8016C102.071 22.38 103.106 23.1846 103.959 24.1698C104.806 25.1497 105.473 26.2775 105.928 27.4991C106.887 29.9659 106.887 32.7137 105.928 35.1805C105.457 36.3885 104.774 37.4983 103.912 38.4548C103.038 39.4107 101.987 40.1806 100.821 40.7201C99.5867 41.3026 98.2422 41.6003 96.8828 41.5919ZM91.0901 31.254C91.0899 32.1212 91.2237 32.983 91.4866 33.8076C91.7312 34.6001 92.1162 35.34 92.6223 35.9905C93.1198 36.6241 93.7427 37.1434 94.4502 37.5144C95.2216 37.894 96.0669 38.0911 96.9231 38.0911C97.7794 38.0911 98.6247 37.894 99.3961 37.5144C100.107 37.1309 100.73 36.5974 101.224 35.9493C101.719 35.2887 102.099 34.5455 102.346 33.7526C102.866 32.1151 102.866 30.3517 102.346 28.7141C102.089 27.9229 101.698 27.184 101.19 26.5312C100.694 25.8998 100.071 25.3848 99.3625 25.021C98.5928 24.6436 97.75 24.4476 96.8963 24.4476C96.0425 24.4476 95.1997 24.6436 94.43 25.021C93.7212 25.3959 93.1 25.9228 92.6089 26.5655C92.1144 27.2206 91.7368 27.9595 91.4933 28.7484C91.234 29.5576 91.098 30.4026 91.0901 31.254Z", fill: "#EA0029" }),
            React.createElement("path", { d: "M113.488 28.3846V41.4272H109.611V21.0602H112.614L123.017 34.4391V21.0946H126.895V41.4478H123.75L113.488 28.3846Z", fill: "#EA0029" }),
            React.createElement("path", { d: "M131.041 41.4478V21.0603H138.292C139.76 21.0316 141.218 21.3071 142.579 21.8703C143.737 22.3505 144.779 23.0834 145.631 24.0178C146.483 24.9521 147.125 26.0653 147.512 27.2795C147.929 28.5515 148.138 29.8851 148.13 31.2266C148.154 32.6589 147.926 34.0841 147.458 35.4345C147.032 36.6369 146.358 37.7312 145.48 38.6423C144.602 39.5535 143.541 40.2599 142.371 40.7133C141.084 41.2144 139.716 41.4636 138.339 41.4478H131.041ZM144.219 31.2266C144.229 30.3119 144.097 29.4015 143.829 28.5288C143.59 27.7463 143.197 27.0222 142.673 26.4008C142.161 25.804 141.522 25.3344 140.805 25.0279C140.01 24.6874 139.154 24.5192 138.292 24.5337H134.932V37.9743H138.292C139.166 37.9923 140.033 37.8143 140.832 37.4526C141.547 37.1278 142.181 36.642 142.687 36.0317C143.201 35.4036 143.589 34.6782 143.829 33.8968C144.1 33.034 144.236 32.1328 144.232 31.2266H144.219Z", fill: "#EA0029" }),
            React.createElement("path", { d: "M165.031 37.9743V41.4478H151.201V21.0602H164.775V24.5337H155.052V29.4486H163.458V32.6612H155.052V37.9743H165.031Z", fill: "#EA0029" }),
            React.createElement("path", { d: "M168.068 41.4477V21.0602H176.892C177.772 21.0535 178.641 21.2556 179.432 21.6506C180.196 22.0289 180.881 22.5558 181.448 23.2019C182.018 23.8468 182.471 24.5907 182.785 25.3986C183.095 26.177 183.257 27.0087 183.262 27.8492C183.277 29.1194 182.941 30.3682 182.295 31.453C181.685 32.4988 180.764 33.3188 179.667 33.7938L184.216 41.4615H179.862L175.783 34.597H171.966V41.4615L168.068 41.4477ZM171.946 31.151H176.804C177.154 31.154 177.498 31.0667 177.806 30.897C178.115 30.7255 178.387 30.492 178.605 30.2106C178.839 29.8959 179.018 29.5431 179.136 29.1672C179.273 28.7489 179.341 28.3106 179.338 27.8698C179.34 27.42 179.262 26.9736 179.109 26.5518C178.971 26.1677 178.766 25.812 178.504 25.5015C178.263 25.216 177.968 24.9826 177.638 24.8151C177.327 24.6552 176.984 24.5707 176.636 24.568H171.932L171.946 31.151Z", fill: "#EA0029" }),
            React.createElement("path", { d: "M57.1673 13.6328L48.9756 16.2413C45.6658 12.874 41.1847 10.9835 36.5133 10.9835C31.8419 10.9835 27.3608 12.874 24.051 16.2413L15.866 13.6328L20.355 21.7055C19.2275 24.2938 18.7119 27.1168 18.8499 29.9463C18.9879 32.7758 19.7756 35.5324 21.1493 37.9935C22.523 40.4546 24.4443 42.551 26.7578 44.1134C29.0713 45.6757 31.7122 46.6603 34.467 46.9874L36.4831 50.5638L38.4991 46.9874C41.2539 46.6603 43.8948 45.6757 46.2083 44.1134C48.5218 42.551 50.4431 40.4546 51.8168 37.9935C53.1906 35.5324 53.9782 32.7758 54.1162 29.9463C54.2542 27.1168 53.7386 24.2938 52.6112 21.7055L57.1673 13.6328ZM36.5167 13.221C40.1976 13.2259 43.7566 14.5692 46.5564 17.0102L41.0392 18.7606L36.5099 26.7715L31.9873 18.7606L26.4702 17.0102C29.2733 14.5703 32.8339 13.2273 36.5167 13.221ZM25.0926 39.7659C23.2413 37.7092 21.9555 35.1889 21.3654 32.4608C20.7753 29.7326 20.902 26.8936 21.7326 24.2316L28.1502 35.6953L29.9848 33.0319L21.9812 18.6645L30.0453 21.2318L34.9442 29.8399L29.5681 38.2969L33.0558 44.475C30.0046 43.7623 27.2371 42.1202 25.1195 39.7659H25.0926ZM36.5167 44.674L32.9282 38.3793L36.4629 32.7779L39.9506 38.544L36.5167 44.674ZM51.9727 29.0505C51.9799 32.6325 50.7945 36.1105 48.611 38.9135C46.4276 41.7164 43.376 43.6776 39.9573 44.475L43.3173 38.4891L38.1093 29.8467L43.0082 21.2318L51.0723 18.6645L43.0082 33.128L44.7621 35.9355L51.3075 24.2247C51.7864 25.786 52.0222 27.4144 52.0064 29.0505H51.9727Z", fill: "#EA0029" }))));
};
...
var Logo = function (_a) {
    ...
    return (React.createElement(Flex, { style: { display: 'flex', alignItems: 'center', height: '100%' } },
        React.createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush }, isPushed ? (React.createElement(Icon$o, { width: "28px", color: "textSubtle" })) : (React.createElement(Icon$p, { width: "28px", color: "textSubtle" }))),
...
var AccountModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: "Your wallet", onDismiss: onDismiss },
        ...
        React.createElement(Flex, { mb: "32px" },
            React.createElement(LinkExternal, { small: true, href: "https://bkcscan.com/address/" + account, mr: "16px" }, "View on BkcScan"),
