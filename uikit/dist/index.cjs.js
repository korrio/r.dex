...
var Breadcrumbs = function (_a) {
    ...
    return (React__default['default'].createElement(StyledBreadcrumbs, null, items === null || items === void 0 ? void 0 : items.map(function (item, index) { return (React__default['default'].createElement("li", { key: "child-" + index }, item)); })));
};
...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, { style: { display: 'flex', alignItems: 'center', height: '100%' } },
        React__default['default'].createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush }, isPushed ? (React__default['default'].createElement(Icon$o, { width: "28px", color: "textSubtle" })) : (React__default['default'].createElement(Icon$p, { width: "28px", color: "textSubtle" }))),
...
var AccountModal = function (_a) {
    ...
    return (React__default['default'].createElement(Modal, { title: "Your wallet", onDismiss: onDismiss },
        ...
        React__default['default'].createElement(Flex, { mb: "32px" },
            React__default['default'].createElement(LinkExternal, { small: true, href: "https://bkcscan.com/address/" + account, mr: "16px" }, "View on BkcScan"),
